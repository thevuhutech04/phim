...
namespace PhimMoiDaDen.Migrations
{
    ...
    public partial class InitialWithRoles : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "CreatedAt", "Email", "FullName", "Password", "RoleId", "Username" },
                values: new object[] { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@example.com", "Administrator", "6G94qKPK8LYNjnTllCqm2G3BUM08AzOK7yW30tfjrMc=", 1, "admin" });
